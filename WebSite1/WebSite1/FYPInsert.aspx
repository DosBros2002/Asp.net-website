<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FYPInsert.aspx.cs" Inherits="FYPInsert" %>
       ...
       <div class="wrapper side-panel-open">
          <div class="main">
              <div class="signup-signup">
                <h2 style="margin-left:5vw">Add FYP</h2>
                
                <div class="input-field">
                    <i class="fas fa-address-card"></i>
                <asp:TextBox runat="server" ID="Name" placeholder="Title" ></asp:TextBox>
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    <i class="fas fa-address-card"></i>
                         <asp:TextBox runat="server" ID="Desc" placeholder="Description" ></asp:TextBox>                        
                </div>
                <div class="input-field">
                    <i class="fas fa-hashtag"></i>
                         <asp:TextBox runat="server" ID="Deadline" placeholder="Deadline" ></asp:TextBox>                        
                </div>
          ...
          <div class="side-panel">
              ...
              <asp:Button OnClick="OpenHome" runat="server" ID="button5" Cssclass="btn"  Text="HOME" />
               ...
               <asp:Button OnClick="FYPINFO" runat="server" ID="button6" Cssclass="btn"  Text="FYP INFO" />
                <asp:Button OnClick="PANELINFO" runat="server" ID="button2" Cssclass="btn"  Text="PANEL INFO" />
                ...
                <asp:Button OnClick="OpenEval" runat="server" ID="button3" Cssclass="btn"  Text="EVALUATION INFO" />
