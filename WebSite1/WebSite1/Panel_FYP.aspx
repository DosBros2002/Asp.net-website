<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Panel_FYP.aspx.cs" Inherits="Panel_FYP" %>
...
<body>
    ...
    <div class="back">Missing Evaluations of FYP</div>
    <form id="form1" runat="server">
       <div class="wrapper side-panel-open">
          <div class="main">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="MissEval" ForeColor="#333333" GridLines="None">
              ...
              <asp:SqlDataSource ID="MissEval" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>"></asp:SqlDataSource>
           </div>
