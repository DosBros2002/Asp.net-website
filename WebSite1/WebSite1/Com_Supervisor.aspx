<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Com_Supervisor.aspx.cs" Inherits="Com_Supervisor" %>
...
<body>
    ...
    <form id="form1" runat="server">
       ...
       <div class="wrapper side-panel-open">
          <div class="main">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Faculty_Num" DataSourceID="AdminStart" ForeColor="#1D2941" GridLines="None" CssClass="grid">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FYP_Supervising" HeaderText="FYP_Supervising" SortExpression="FYP_Supervising" />
                    </Columns>
        ...
        <asp:SqlDataSource ID="AdminStart" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" SelectCommand="SELECT Faculty.F_Num AS Faculty_Num, Faculty.P_name AS Name, supervises.Proj_ID AS FYP_Supervising FROM Faculty INNER JOIN supervises ON Faculty.F_Num = supervises.S_ID"></asp:SqlDataSource>
              <p>
