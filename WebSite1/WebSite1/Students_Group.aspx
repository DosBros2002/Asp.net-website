<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Students_Group.aspx.cs" Inherits="Students_Group" %>
...
<body>
    ...
    <form id="form2" runat="server">
       ...
       <div class="wrapper side-panel-open">
          <div class="main">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackImageUrl="~/8-80446_blur-wallpapers-25-1680-x-1050-dark-blue.jpg"  CellSpacing="60" CssClass="grid" CellPadding="8" DataKeyNames="roll_num" DataSourceID="Group" ForeColor="#ffffff" GridLines="None">
                <AlternatingRowStyle BackColor="transparent" ForeColor="White" />
                <Columns >
                    <asp:BoundField DataField="Member_Name" HeaderText="Group Members Names" SortExpression="Member_Name" />
                    <asp:BoundField DataField="roll_num" HeaderText="Roll Numbers" ReadOnly="True" SortExpression="roll_num" />
                    <asp:BoundField DataField="Group_ID" HeaderText="Group IDs" SortExpression="Group_ID" />
                </Columns>
            ...
            <asp:SqlDataSource ID="Group" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" ></asp:SqlDataSource>
