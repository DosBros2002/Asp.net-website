<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommiteePanelMem.aspx.cs" Inherits="CommiteePanelMem" %>
...
<body>
    ...
    <form id="form1" runat="server">
       ...
       <div class="wrapper side-panel-open">
          <div class="main">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Faculty_Num" DataSourceID="AdminStart" ForeColor="#1D2941" GridLines="None" CssClass="grid">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FYP_Evaluating" HeaderText="FYP_Evaluating" SortExpression="FYP_Evaluating" />
                    </Columns>
        ...
        <asp:SqlDataSource ID="AdminStart" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" SelectCommand="select Faculty.F_Num as Faculty_Num,Faculty.P_name as Name,evaluates.Proj_ID as FYP_Evaluating from Faculty,evaluates where evaluates.S_ID = Faculty.F_Num"></asp:SqlDataSource>
              <p>
