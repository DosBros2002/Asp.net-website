<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Com_Evaluations.aspx.cs" Inherits="Com_Evaluations" %>
...
<body>
    ...
    <form id="form1" runat="server">
       ...
       <div class="wrapper side-panel-open">
          <div class="main">
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Faculty_Num" DataSourceID="AdminStart" ForeColor="#1D2941" GridLines="None" CssClass="grid">
                    <AlternatingRowStyle BackColor="transparent" ForeColor="White" />
                    <Columns>
                        <asp:BoundField DataField="Faculty_Num" HeaderText="Faculty_Num" SortExpression="Faculty_Num" ReadOnly="True" />
                        <asp:BoundField DataField="Panel_Member_Name" HeaderText="Panel_Member_Name" SortExpression="Panel_Member_Name" />
                    </Columns>
        ...
        <asp:SqlDataSource ID="AdminStart" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" SelectCommand="select Faculty.F_Num as Faculty_Num,Faculty.P_name as Panel_Member_Name from Evaluates inner join Faculty on Evaluates.S_ID = Faculty.F_Num where Evaluates.Review = NULL;"></asp:SqlDataSource>
