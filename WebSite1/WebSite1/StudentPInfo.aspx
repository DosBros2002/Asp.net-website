<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentPInfo.aspx.cs" Inherits="StudentPInfo" %>
...
<body style="height: 975px; background-color: #9999FF">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="PanelMembers" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" ></asp:SqlDataSource>
        <br />
        <br />
        <span class="auto-style3">&nbsp;Reviews for Your Project<br />
        <br />
        </span>
        <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="Review">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <EditRowStyle BackColor="#999999" />
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
         ...
         <asp:SqlDataSource ID="Review" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" ></asp:SqlDataSource>
        <br />
        <br />
        <span class="auto-style3">&nbsp;Supervisor for Your Project<br />
        <br />
        </span>
        <asp:GridView ID="GridView3" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" DataSourceID="Supervises">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <EditRowStyle BackColor="#999999" />
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
         ...
         <asp:SqlDataSource ID="Supervises" runat="server" ConnectionString="<%$ ConnectionStrings:Project1ConnectionString %>" ></asp:SqlDataSource>
        <br />
